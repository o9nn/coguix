...
(define-public (Any . x)
	(apply cog-new-node (append (list AnyNodeType) x)))
(define-public WordClassNodeType (cog-type->int 'WordClassNode))
(define-public (WordClassNode . x)
	(apply cog-new-node (append (list WordClassNodeType) x)))
(define-public (WordClass . x)
	(apply cog-new-node (append (list WordClassNodeType) x)))
...
(define-public (SpecificEntity . x)
	(apply cog-new-node (append (list SpecificEntityNodeType) x)))
(define-public LgDictNodeType (cog-type->int 'LgDictNode))
(define-public (LgDictNode . x)
	(apply cog-new-node (append (list LgDictNodeType) x)))
(define-public (LgDict . x)
	(apply cog-new-node (append (list LgDictNodeType) x)))
(define-public LgHaveDictEntryType (cog-type->int 'LgHaveDictEntry))
(define-public (LgHaveDictEntry . x)
	(apply cog-new-link (append (list LgHaveDictEntryType) x)))
(define-public (LgHaveDictEntry . x)
	(apply cog-new-link (append (list LgHaveDictEntryType) x)))
(define-public LgDictEntryType (cog-type->int 'LgDictEntry))
(define-public (LgDictEntry . x)
	(apply cog-new-link (append (list LgDictEntryType) x)))
(define-public (LgDictEntry . x)
	(apply cog-new-link (append (list LgDictEntryType) x)))
(define-public LgParseLinkType (cog-type->int 'LgParseLink))
(define-public (LgParseLink . x)
	(apply cog-new-link (append (list LgParseLinkType) x)))
(define-public (LgParse . x)
	(apply cog-new-link (append (list LgParseLinkType) x)))
(define-public LgParseMinimalType (cog-type->int 'LgParseMinimal))
(define-public (LgParseMinimal . x)
	(apply cog-new-link (append (list LgParseMinimalType) x)))
(define-public (LgParseMinimal . x)
	(apply cog-new-link (append (list LgParseMinimalType) x)))
...
(define-public (SetSize . x)
	(apply cog-new-link (append (list SetSizeLinkType) x)))
(define-public MyNotLinkType (cog-type->int 'MyNotLink))
(define-public (MyNotLink . x)
	(apply cog-new-link (append (list MyNotLinkType) x)))
(define-public (MyNot . x)
	(apply cog-new-link (append (list MyNotLinkType) x)))
(define-public MyOrLinkType (cog-type->int 'MyOrLink))
(define-public (MyOrLink . x)
	(apply cog-new-link (append (list MyOrLinkType) x)))
(define-public (MyOr . x)
	(apply cog-new-link (append (list MyOrLinkType) x)))
